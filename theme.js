...
$(function () {
    ...
    $(".choose-skin li").on("click", function () {
        ...
        $(".choose-skin li").removeClass("active"), t.addClass("active"), e.attr("data-qboat", "theme-" + t.data("theme"))
    }), $(".password-meter .form-control").on("input", function () {
        var e = 0, t = $(this).val(), n = new RegExp("[A-Z]"), c = new RegExp("[a-z]"), o = new RegExp("[0-9]"),
            l = new RegExp("^(?=.*?[#?!@$%^&*-]).{1,}$");
        7 < t.length && e++, 0 < t.length && t.match(n) && e++, 0 < t.length && t.match(c) && e++, 0 < t.length && t.match(o) && e++, 0 < t.length && t.match(l) && e++, $(".password-meter .progress-bar")[0].style.width = 20 * e + "%"
    ...
    $(".card-fullscreen").on("click", function (e) {
        ...
        return $(this).closest(t).toggleClass("card-collapsed"), e.preventDefault(), !1
        ...
        $(this).is(":checked") ? $("body").addClass("sidebar-v2") : $("body").removeClass("sidebar-v2")
...
currentTheme && (document.documentElement.setAttribute("data-theme", currentTheme), "dark" === currentTheme) && (toggleSwitch.checked = !0), toggleSwitch.addEventListener("change", switchTheme, !1), document.getElementById("NotificationsDiv") && document.getElementById("NotificationsDiv").addEventListener("click", function (e) {
    e.stopPropagation()
});
...
$(function() {
    ...
    flashCallback = function() {
        return $(".alert-dismissible").fadeOut();
    };
